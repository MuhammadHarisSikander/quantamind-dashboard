...
// sections
import { TeamHead, } from '../sections/@dashboard/team';
// mock
...
const TABLE_HEAD = [
    ...
    { id: 'role1', label: 'Role1', alignRight: false },
    { id: 'role2', label: 'Role2', alignRight: false },
    { id: 'role3', label: 'Role3', alignRight: false },
    { id: 'role4', label: 'Role4', alignRight: false },
                                    ...
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        ...
                                        return (
                                            <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell padding="checkbox">
                                                    <Checkbox checked onChange={(event) => handleClick(event, name)} />
                                                </TableCell>
                                                <TableCell padding="checkbox">
                                                    <Checkbox checked onChange={(event) => handleClick(event, name)} />
                                                </TableCell>
